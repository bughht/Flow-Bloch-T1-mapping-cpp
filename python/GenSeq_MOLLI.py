...
if __name__ == "__main__":
    ...
    molli = MOLLI(readout_seq="TR2.8_FA35_FOV256_K64_thick8_center_first",
                  dt=20)
    molli.generate("MOLLI_533_TR2.8_FA35_FOV256_K64_thick8_dt20_center_first")
